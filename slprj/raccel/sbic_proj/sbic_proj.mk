...
MODEL                = sbic_proj
MODULES              = rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c sbic_proj.c sbic_proj_capi.c sbic_proj_data.c sbic_proj_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = sbic_proj.exe
MAKEFILE             = sbic_proj.mk
MATLAB_ROOT          = C:/Program Files/Polyspace/R2020b
ALT_MATLAB_ROOT      = C:/PROGRA~1/POLYSP~1/R2020b
MATLAB_BIN           = C:/Program Files/Polyspace/R2020b/bin
ALT_MATLAB_BIN       = C:/PROGRA~1/POLYSP~1/R2020b/bin
START_DIR            = C:/Users/MANUEL~1/DOCUME~1/02C61~1.FEU/4ANO/2S/SBIC/PL/projeto/MIXERC~1
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 2
NCSTATES             = 4
BUILDARGS            =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="C:\\Program Files\\Polyspace\\R2020b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/sbic_proj \
